      ...
      <div>
        <ul className="pl-4">
          ...
          <li className="bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl">
            <a
              href="#"
              className="bg-[#90d6f8] p-4 flex justify-center rounded-xl text-[#1F1D2B]"
            >
          ...
          <li className="hover:bg-[#262837] p-4 rounded-tl-xl rounded-bl-xl group transition-colors">
            <a
              href="#"
              className="group-hover:bg-[#90d6f8] p-4 flex justify-center rounded-xl text-[#90d6f8] group-hover:text-[#1F1D2B] transition-colors"
            >
